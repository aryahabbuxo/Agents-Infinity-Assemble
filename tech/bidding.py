...
def submit_bid(
    ...
    """
    Public bidding function used by service.py.
    """

    confidence_result = estimate_raw_confidence(
        ticket
    )

    raw_confidence = confidence_result[
        "raw_confidence"
    ]
    ...
    return {
        ...
        "bid": {
            ...
            "reason": (
                "Bid based on technical issue indicators "
                "and current agent load."
            ),
            "matched_keywords": confidence_result[
                "matched_keywords"
            ],
            "estimated_effort": (
                "low"
...
def share_capability():
    ...
    return {
        ...
        "sender": AGENT_NAME,
        "capability": TECHNICAL_CAPABILITY_CARD
    }
