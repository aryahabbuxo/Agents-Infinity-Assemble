...
class TechnicalNegotiationHandler:
    ...
    def handle_proposal(self, proposal):
        ...
        req_subtask = (
            proposal.get("your_requested_subtask") or proposal.get("requested_subtask") or ""
        ).lower()
        my_subtask = (
            proposal.get("my_assigned_subtask") or proposal.get("my_subtask") or ""
        ).lower()
        rationale = (proposal.get("rationale") or "").lower()
        combined = f"{req_subtask} {my_subtask} {rationale}"
        ...
        if is_technical or not combined.strip():
            return make_accept(
